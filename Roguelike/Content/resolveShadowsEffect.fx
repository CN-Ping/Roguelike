...
technique DrawShadowsNoAttenuation
{
    ...
    {          
        ...
        PixelShader  = compile ps_4_0 DrawShadowsNoAttenuationPS();
    }
}
...
technique DrawShadowsNoAttenuationPreBlur
{
    ...
    {          
        VertexShader = compile vs_4_0 FullScreenVS();
        PixelShader  = compile ps_4_0 DrawShadowsNoAttenuationPreBlurPS();
    }
}
...
technique DrawShadowsLinearAttenuation
{
    ...
    {          
        VertexShader = compile vs_4_0 FullScreenVS();
        PixelShader  = compile ps_4_0 DrawShadowsLinearAttenuationPS();
    }
}
...
technique DrawShadowsCurveAttenuation
{
    ...
    {          
        VertexShader = compile vs_4_0 FullScreenVS();
        PixelShader  = compile ps_4_0 DrawShadowsCurveAttenuationPS();
    }
}
...
technique BlurHorizontallyLow
{
    ...
    {          
        VertexShader = compile vs_4_0 FullScreenVS();
        PixelShader  = compile ps_4_0 BlurHorizontallyLowPS();
    }
}
...
technique BlurHorizontallyMid
{
    ...
    {          
        VertexShader = compile vs_4_0 FullScreenVS();
        PixelShader  = compile ps_4_0 BlurHorizontallyMidPS();
    }
}
...
technique BlurHorizontallyHigh
{
    ...
    {          
        VertexShader = compile vs_4_0 FullScreenVS();
        PixelShader  = compile ps_4_0 BlurHorizontallyHighPS();
    }
}
...
technique BlurVerticallyLowNoAttenuation
{
    ...
    {          
        VertexShader = compile vs_4_0 FullScreenVS();
        PixelShader  = compile ps_4_0 BlurVerticallyLowNoAttenuationPS();
    }
}
...
technique BlurVerticallyMidNoAttenuation
{
    ...
    {          
        VertexShader = compile vs_4_0 FullScreenVS();
        PixelShader  = compile ps_4_0 BlurVerticallyMidNoAttenuationPS();
    }
}
...
technique BlurVerticallyHighNoAttenuation
{
    ...
    {          
        VertexShader = compile vs_4_0 FullScreenVS();
        PixelShader  = compile ps_4_0 BlurVerticallyHighNoAttenuationPS();
    }
}
...
technique BlurVerticallyLowLinearAttenuation
{
    ...
    {          
        VertexShader = compile vs_4_0 FullScreenVS();
        PixelShader  = compile ps_4_0 BlurVerticallyLowLinearAttenuationPS();
    }
}
...
technique BlurVerticallyMidLinearAttenuation
{
    ...
    {          
        VertexShader = compile vs_4_0 FullScreenVS();
        PixelShader  = compile ps_4_0 BlurVerticallyMidLinearAttenuationPS();
    }
}
...
technique BlurVerticallyHighLinearAttenuation
{
    ...
    {          
        VertexShader = compile vs_4_0 FullScreenVS();
        PixelShader  = compile ps_4_0 BlurVerticallyHighLinearAttenuationPS();
    }
}
...
technique BlurVerticallyLowCurveAttenuation
{
    ...
    {          
        VertexShader = compile vs_4_0 FullScreenVS();
        PixelShader  = compile ps_4_0 BlurVerticallyLowCurveAttenuationPS();
    }
}
...
technique BlurVerticallyMidCurveAttenuation
{
    ...
    {          
        VertexShader = compile vs_4_0 FullScreenVS();
        PixelShader  = compile ps_4_0 BlurVerticallyMidCurveAttenuationPS();
    }
}
...
technique BlurVerticallyHighCurveAttenuation
{
    ...
    {          
        VertexShader = compile vs_4_0 FullScreenVS();
        PixelShader  = compile ps_4_0 BlurVerticallyHighCurveAttenuationPS();
    }
}
...
technique DistortAndComputeDistances
{
    ...
    {          
        VertexShader = compile vs_4_0 FullScreenVS();
        PixelShader  = compile ps_4_0 DistortAndComputeDistancesPS();
    }
}