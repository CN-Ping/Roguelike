...
namespace Shadows2D
{
    ...
    public class ShadowCasterMap
    {
        ...
        SpriteBatchWrapper spriteBatch;
        public readonly PrecisionSettings PrecisionSettings;
        private float precisionRatio;
        private Vector2 pixelSizeHLSL;

        public ShadowCasterMap(PrecisionSettings precision, GraphicsDeviceManager graphics, SpriteBatchWrapper spriteBatch)
        {
        ...
        public void AddShadowCaster(Texture2D texture, Rectangle destinationRectangle, Rectangle sourceRectangle)
        {
            //TODO: something with the precisionRatio
                // we can't do this with rectangles because of reasons. 
                // I just set everything to max accuracy settings
            
            this.spriteBatch.Draw(texture, destinationRectangle, sourceRectangle, Color.Black);
        }

        public void AddShadowCaster(Texture2D texture, Vector2 position, Nullable<Rectangle> sourceRectangle, Color color, float rotation, Vector2 origin, float scale, SpriteEffects effects, float layerDepth)
        {
        ...
        public void SetSpriteBatch(SpriteBatchWrapper s_In)
        {
            spriteBatch = s_In;
        }
    }
